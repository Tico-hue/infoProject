...
urlpatterns = [
    ...
    path('login/',views.LoginUserView.as_view(template_name = "usuarios/loginContenedor.html"), name = 'login'),
...
#     path('registro/', user_views.register, name='register'),
    ...
    path('busqueda/',views.busquedaPorRubro,name='busquedaPorRubro'),
